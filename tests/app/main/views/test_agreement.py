...
@pytest.mark.parametrize('crown, expected_status, expected_file_fetched, expected_file_served', (
    (
        True, 200, 'crown.pdf',
        'Catalyst Notify data sharing and financial agreement.pdf',
    ),
    (
        False, 200, 'non-crown.pdf',
        'Catalyst Notify data sharing and financial agreement (non-crown).pdf',
    ),
    (
        None, 404, None,
        None,
...
@pytest.mark.parametrize('name, email, expected_paragraph', (
    (None, None, (
        ...
        'Catalyst Notify data sharing and financial agreement (version '
